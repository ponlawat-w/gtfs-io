...
import type { GTFSFileRow } from '../../types.js';
import type { GTFSAgency } from '../../files/agency.js';
import type { GTFSStop } from '../../files/stop.js';
import type { GTFSRoute } from '../../files/route.js';
import type { GTFSTrip } from '../../files/trip.js';
import type { GTFSStopTime } from '../../files/stop-time.js';
import type { GTFSCalendar } from '../../files/calendar.js';
import type { GTFSCalendarDate } from '../../files/calendar-date.js';
import type { GTFSFareAttribute } from '../../files/fare-attribute.js';
import type { GTFSFareRule } from '../../files/fare-rule.js';
import type { GTFSTimeframe } from '../../files/timeframe.js';
import type { GTFSFareMedia } from '../../files/fare-media.js';
import type { GTFSFareProduct } from '../../files/fare-product.js';
import type { GTFSFareLegRule } from '../../files/fare-leg-rule.js';
import type { GTFSFareTransferRule } from '../../files/fare-transfer-rule.js';
import type { GTFSArea } from '../../files/area.js';
import type { GTFSStopArea } from '../../files/stop-area.js';
import type { GTFSNetwork } from '../../files/network.js';
import type { GTFSRouteNetwork } from '../../files/route-network.js';
import type { GTFSShape } from '../../files/shape.js';
import type { GTFSFrequency } from '../../files/frequency.js';
import type { GTFSTransfer } from '../../files/transfer.js';
import type { GTFSPathway } from '../../files/pathway.js';
import type { GTFSLevel } from '../../files/level.js';
import type { GTFSTranslation } from '../../files/translation.js';
import type { GTFSFeedInfo } from '../../files/feed-info.js';
import type { GTFSAttribution } from '../../files/attribution.js';
import { GTFSIOWriteOptions } from '../file/types.js';
